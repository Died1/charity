        ...
        <div class="col-12 imgsec">
          <div class="row innerrow">
            <div class="col-12 white">
              <h1 class="donate-now">Donar Ahora</h1>
              Puede encontrar a continuación varias categorías para las que puede hacer donaciones.
              Elija cualquiera de las categorías para ver los listados en esa categoría.
            </div>
          </div>
        </div>
      </div>
