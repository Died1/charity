...
<nav class="navbar navbar-expand-md navbar-light z-100">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav ml-auto">
            <a href="#" class="nav-item nav-link white">Inicio</a>
            <a href="#about" class="nav-item nav-link white">Nosostros</a>
            <a href="#contact" class="nav-item nav-link white">contactenos</a>
            <?php if(islogged()==1) {
